                    ...
                    <ul>
                      ...
                      foreach ($lessons as $lesson) : ?>
                        <li class="lecture has-preview">
                          <span class="lecture-title <?php if($lesson['is_free'] == 1) echo 'text-primary fw-700'; ?>" onclick="go_course_playing_page('<?php echo $course_details['id']; ?>', '<?php echo $lesson['id']; ?>')"><?php echo $lesson['title']; ?></span>
                          <span class="lecture-time float-right mt--10-sm">
                            <?php if($lesson['duration'] == "")echo'<span class="opacity-0">.</span>'; ?>
                            <?php echo $lesson['duration']; ?>
                          </span>
                          <?php if($lesson['is_free'] == 1): ?>
                            <a href="javascript:;">
                              <span class="lecture-preview float-right mt--10-sm hover-underline" onclick="lesson_preview('<?php echo site_url('home/preview_free_lesson/'.$lesson['id']); ?>', '<?php echo site_phrase('lesson').': '.$lesson['title']; ?>')">
