...
<div class="form-group">
    ...
    <input type="text" class="form-control" data-toggle='timepicker' data-minute-step="5" name="amazon_s3_duration" id = "amazon_s3_duration" data-show-meridian="false" value="<?php echo $lesson_details['duration']; ?>" required>
</div>
