    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-body">
          ...
          <form class="" action="<?php echo site_url('user/payout_settings/peach_payment_settings'); ?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
              <label><?php echo get_phrase('live_entity_id'); ?></label>
              <input type="text" name="live_entity_id" class="form-control" value="<?php echo $peach_payment_keys[0]['live_entity_id']; ?>" required />
            </div>

            <div class="form-group">
              <label><?php echo get_phrase('live_access_token'); ?></label>
              <input type="text" name="live_access_token" class="form-control" value="<?php echo $peach_payment_keys[0]['live_access_token']; ?>" required />
            </div>
