                        ...
                        <?php if (addon_status('live-class')): ?>
                            ...
                            if ($live_class->num_rows() > 0):
                                ...
                                <div style="padding: 30px 0px;">
                                    ...
                                    <?php if($live_class['date']==strtotime($date) && $live_class['time'] < strtotime($time)){ ?>
                            ...
                            <?php else: ?>
                                <div class="alert alert-warning mt-2" role="alert" style="padding: 30px 0px;">
...
function getTimerCount(datetime){
...
var x = setInterval(function() {
  ...
  + minutes + "m " + seconds + "s ");
  document.getElementById("show_time_elapse").innerHTML = days + "d " + hours + "h "
  + minutes + "m " + seconds + "s ";
