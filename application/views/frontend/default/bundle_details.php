...
<div class="position-relative">
  <!-- Hero Section -->
  <div class="gradient-y-overlay-lg-white bg-img-hero py-5" style="/*background: url(<?= $bundle_banner; ?>) right bottom no-repeat; background-size: cover;*/ background-color: #1d2b51;
    color: #FFF;">
    <div class="container">
      <div class="row">
        <div class="col-md-10">
          ...
          <div class="d-flex align-items-center flex-wrap w-100">
            <div class="d-flex align-items-center flex-wrap w-100">
              ...
              <div class="d-flex align-items-center">
                ...
                <!-- <span class="pl-2"><?= site_phrase('created_by'); ?> <a class="link-underline" href="<?php echo site_url('home/instructor_page/'.$instructor_details['id']) ?>"><?php echo $instructor_details['first_name'].' '.$instructor_details['last_name']; ?></a></span> --> <span> <?= site_phrase('last_updated'); ?></span>, 
