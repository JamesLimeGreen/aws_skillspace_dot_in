    ...
    <div class="row align-items-end">
      <div class="col-lg-8">
        <div class="course-header-wrap">
          <div class="course-varient">
            <i class="fas fa-award fa-2x"></i><span class="badge bg-primary">Top Courses</span>
          </div>
          ...
          <div class="rating-row">
            ...
            <span class="badge bg-primary text-11px"> <?= site_phrase($course_details['level']); ?></span>
            <span class="badge bg-primary badge-langauge text-11px"> <?= ucfirst($course_details['language']); ?></span>
            ...
            <span class="created-by">
              ...
              <?php if ($course_details['multi_instructor']) : ?>
                ...
                <?php foreach ($instructors as $key => $instructor) : ?>
                  ...
                  <img style="margin-left: <?php echo $margin; ?>px;" class="position-absolute" src="<?php echo $this->user_model->get_user_image_url($instructor['id']); ?>" width="25px" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo $instructor['first_name'].' '.$instructor['last_name']; ?>" onclick="return check_action(this,'<?php echo site_url('home/instructor_page/'.$instructor['id']); ?>');">
              ...
              <?php else : ?>
                ...
                <img src="<?php echo $this->user_model->get_user_image_url($instructor_details['id']); ?>" width="25px" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo $instructor_details['first_name'].' '.$instructor_details['last_name']; ?>"  onclick="return check_action(this,'<?php echo site_url('home/instructor_page/'.$instructor_details['id']); ?>');">
          ...
          <div class="created-row">
            ...
            <?php
              ...
              <span>(<?php echo $number_of_ratings . ' ' . site_phrase('reviews'); ?>)</span>
    ...
    <div class="row">
      <div class="col-lg-8 order-last order-lg-first radius-10 mt-4 bg-white p-30-40">
            ...
            <div class="course-curriculum-accordion">
              ...
              foreach ($sections as $key => $section) : ?>
                <div class="lecture-group-wrapper">
                  ...
                  <div class="lecture-group-title clearfix" style="<?= $style; ?>" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo $section['id']; ?>" aria-expanded="<?= (($counter == 0)?"true":"false"); ?>">
                        ...
                        <li class="lecture has-preview text-14px ">
                          ...
                          <div class="lecture-info float-lg-end">
                            ...
                            <span class="lecture-time ps-2">
                              ...
                              <?= ($lesson['duration']!="00:00:00"?$lesson['duration']:""); ?>
                            </span>
                          </div>
                        </li>
                      <?php endforeach; ?>
        ...
        <div class="description-box view-more-parent">
          ...
          <div class="description-title"><?php echo site_phrase('course_description'); ?></div>
        ...
        <div class="requirements-box mt-2 mb-4">
                ...
                <?php }else{ ?>
                  ...
                  <div class="buy-btns">
                    <?php if (in_array($course_details['id'], $this->session->userdata('cart_items'))) { ?>
                      ...
                      <button class="btn btn-cart-now active addedToCart" type="button" id="<?php echo $course_details['id']; ?>" onclick="handleCartItems(this)"><?php echo site_phrase('added_to_cart'); ?></button>

                    <?php }else{ ?>

                      <!-- Buy Now -->

                      <button class="btn btn-buy-now" type="button" id="course_<?php echo $course_details['id']; ?>" onclick="handleBuyNow(this)"><?php echo site_phrase('buy_now'); ?></button>

                      <!-- Buy Now -->

                      <button class="btn btn-cart-now big-cart-button-<?php echo $course_details['id']; ?>" type="button" id="<?php echo $course_details['id']; ?>" onclick="handleCartItems(this)"><?php echo site_phrase('add_to_cart'); ?></button>
                    <?php } ?>
                  </div>
