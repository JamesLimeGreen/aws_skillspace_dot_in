<!-- class="" d-print-none -->
<footer class="footer-area  bg-gray mt-5">
    ...
    <div class="row mb-3">
      ...
      <div class="col-6 col-sm-6 col-md-3">
        ...
        <ul class="list-unstyled text-small">
          ...
          <li class="mb-1"><a class="link-secondary footer-hover-link" href="<?php echo site_url('blogs'); ?>"><?php echo site_phrase('blogs'); ?></a></li>
          ...
          <?php }else{ ?>
            <li class="mb-1"><a class="link-secondary footer-hover-link" href="<?php echo site_url('home/my_courses'); ?>"><?php echo site_phrase('my_courses'); ?></a></li>
            <li class="mb-1"><a class="link-secondary footer-hover-link" href="<?php echo site_url('home/profile/user_profile'); ?>"><?php echo site_phrase('my_profile'); ?></a></li>
          <?php } ?>
  ...
  <section class="border-top">
    <div class="container-xl">
      <div class="row mt-3 py-1">
        <div class="col-8 col-sm-8 col-md-3 text-muted text-13px">
          &copy; <?= date('Y');?> <?php echo get_settings('system_name'); ?>, <?php echo site_phrase('all_rights_reserved'); ?>
        </div>

        <div class="col-6 col-sm-6 col-md-3 d-none d-md-block"></div>
        <div class="col-6 col-sm-6 col-md-3 d-none d-md-block"></div>
        <div class="col-4 col-sm-4 col-md-3 text-center text-md-start">
