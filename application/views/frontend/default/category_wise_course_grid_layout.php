    ...
    <?php foreach ($courses as $course) :
        ...
        <div class="col-md-6 col-xl-4">
            <div class="course-box-wrap">
                ...
                <!-- <span class="courses_badge_wishlist text-primary" onclick="handleWishList(this)" id="<?php echo $course['id']; ?>"><i class="fa fa-heart"></i></span>
                <span class="courses_badge_cart text-primary"  id="<?php echo $course['id']; ?>" onclick="handleCartItems(this)"><i class="fa fa-cart-plus"></i></span>  -->  
