        ...
        <div class="row">
                                    ...
                                    foreach ($categories as $category) : ?>
                                        <li class="mt-3">
                                            <div class="text-15px fw-700 <?php if ($counter > $number_of_visible_categories) : ?> hidden-categories hidden <?php endif; ?>">
                                                ...
                                                <label for="category-<?php echo $category['id']; ?>" title="<?= $category['name']; ?>"><?php echo ellipsis($category['name'],27); ?></label>
            ...
            <div class="col-lg-9">
                <div class="row category-filter-box mx-0" >
                    <div class="col-md-6">
                        <button class="btn py-1 px-2 mx-2 <?php if($this->session->userdata('layout') == 'grid'){echo 'btn-blue';}else{echo 'btn-light'; } ?>" onclick="toggleLayout('grid')"><i class="fas fa-th-large"></i></button>
                        <button class="btn py-1 px-2 mx-2 <?php if($this->session->userdata('layout') == 'list'){echo 'btn-blue';}else{echo 'btn-light'; } ?>" onclick="toggleLayout('list')"><i class="fas fa-list"></i></button>
                ...
                <nav>
                    <?php if ($selected_category_id == "all" && $selected_price == 'all' && $selected_level == 'all' && $selected_rating == 'all' || !empty($this->uri->segment(3))) {
