    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <span type="button" class="close pull-right" data-bs-dismiss="modal" aria-hidden="true">&times;</span>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="margin-top:100px;">
            ...
            <div class="modal-footer" style="margin:0px; border-top:0px; text-align:center;">
                ...
                <button type="button" class="btn btn-info btn-cancel" data-bs-dismiss="modal"><?php echo site_phrase('no');?></button>
            </div>
        </div>
    </div>
</div>
