...
.paypal-form, .stripe-form, .razorpay-form, .peach_payment-form {
	display: none;
}
...
$total_price_of_checking_out = $this->session->userdata('total_price_of_checking_out')-$this->session->userdata('discount_price');
		...
		<div class="col-md-8">
			<div class="row">
				<div class="col-md-3">
					...
					<div class="row payment-gateway peach_payment" onclick="selectedPaymentGateway('peach_payment')">
						<div class="col-12">
							<img class="tick-icon peach_payment-icon" src="<?php echo base_url('assets/payment/tick.png'); ?>">
							<img class="payment-gateway-icon" src="<?php echo base_url('assets/payment/peach-payment.png'); ?>">
						</div>
					</div>
					<?php endif; ?>
			...
			<div class="col-md-8">
				<div class="w-100 d-grid">
					...
					<div class="w-100 float-start mt-4 indicated-price">
						<div class="float-end total-price"><?php echo currency($discount_price); ?></div>
						<div class="float-end total"><?php echo get_phrase('discount'); ?></div>
					</div>
					<?php } ?>

					<div class="w-100 float-start mt-1 indicated-price">
					...
					<div class="w-100 float-start">
						...
						<form action="<?php echo site_url('home/peach_payment_checkout'); ?>" method="post" class="peach_payment-form form">
							<hr class="border mb-4">
							<input type="hidden" name="total_price_of_checking_out" value="<?php echo $total_price_of_checking_out; ?>">
							<button type="submit" class="payment-button float-right">Pay via Peach Payments</button>
						</form>
