        ...
        <div class="card-body">
          ...
          <form class="" action="<?php echo site_url('user/payout_settings/razorpay_settings'); ?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <input type="text" name="key_id"  class="form-control" value="<?php echo $payment_keys['razorpay']['key_id']; ?>" required />
            </div>

            <div class="form-group">
              <label><?php echo get_phrase('secret_key'); ?></label>
              <input type="text" name="secret_key" class="form-control" value="<?php echo $payment_keys['razorpay']['secret_key']; ?>" required />
            </div>
