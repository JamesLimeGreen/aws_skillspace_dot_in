	    ...
	    <div class="card">
	        <div class="card-body">
	            ...
	            <div class="chat-conversation" id="chat-conversation">
	                <ul class="conversation-list slimscroll" id="conversation-list slimscroll" style="max-height: 250px;">
	                	<?php
	                ...
	                <form method="post" action="<?php echo site_url('admin/message/send_reply/'.$current_message_thread_code); ?>" class="needs-validation" novalidate name="chat-form" id="chat-form">
	                    <div class="row">
	                        <div class="col">
	                            <input type="text" name="message" required="" class="form-control chat-input" placeholder="Enter your text" required>
...
<script type="text/javascript">
 ...
 //      var elem = document.getElementsByClassName("slimScrollDiv");
