...
<div class="left-side-menu left-side-menu-detached">
	...
	<ul class="metismenu side-nav side-nav-light">
		...
		<?php if (has_permission('settings')) : ?>
			<li class="side-nav-item  <?php if ($page_name == 'system_settings' || $page_name == 'frontend_settings' || $page_name == 'payment_settings' || $page_name == 'smtp_settings' || $page_name == 'manage_language' || $page_name == 'about' || $page_name == 'themes' || $page_name == 'banner') : ?> active <?php endif; ?>">
				<a href="javascript: void(0);" class="side-nav-link">
				...
				<ul class="side-nav-second-level" aria-expanded="false">
					...
					<li class="<?php if ($page_name == 'banner') echo 'active'; ?>">
						<a href="<?php echo site_url('admin/banner'); ?>"><?php echo get_phrase('banner'); ?></a>
					</li>
