...
<?php $banner_details = $this->crud_model->get_banner_details_by_id($banner_id)->row_array(); ?>
<!-- start page title -->
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
        ...
        <div class="card">
            <div class="card-body">
              <div class="col-lg-12">
                ...
                <form class="required-form" action="<?php echo site_url('admin/submitBanner/edit/'.$banner_id); ?>" method="post" enctype="multipart/form-data">
                    
                    <input type="hidden" name="oimg" value="<?= $banner_details['banner']; ?>">

                    <div class="form-group">
                        <label for="heading"><?php echo get_phrase('banner_heading'); ?><span class="required">*</span></label>
                        <input type="text" class="form-control" id="heading" name = "heading" placeholder="Enter Heading" required="" value="<?= $banner_details['heading'];?>">
                    </div>
                    ...
                    <div class="form-group" id = "thumbnail-picker-area">
                        ...
                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="category_thumbnail" name="banner" accept="image/*" onchange="changeTitleOfImageUploader(this)">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description"><?= $banner_details['description'];?></textarea>
                    </div>
