...
<div class="row">
	<?php if(count($categories->result_array())>0): foreach($categories->result_array() as $category): ?>
	...
	<?php endforeach; else: ?>
		<div class="col-md-4 mb-3">
			<ul class="list-group list-group-numbered alert-danger">
				<li class="list-group-item d-flex justify-content-between align-items-start alert-danger">
					<div class="ml-2 mr-auto">
						<div class="fw-bold" style="font-size: 20px; font-weight: 600;">Blog Category Not found.</div>
					</div>
				</li>
			</ul>
		</div>
