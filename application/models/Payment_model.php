...
class Payment_model extends CI_Model {
  ...
  {
    $payable_amount = $this->session->userdata('total_price_of_checking_out')-$this->session->userdata('discount_price');
  ...
  public function razorpayPrepareDataAdmin($user_id = "", $is_instructor_payment = false, $amount_for_instructor_payment = 0)
  {
    $user_details = $this->user_model->get_user($user_id)->row_array();
