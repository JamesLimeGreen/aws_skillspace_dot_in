...
class Blog extends CI_Controller
{
    ...
    function index(){
        ...
        $page_data['popular_blogs'] = $this->crud_model->get_popular_blogs(6,$current_language);
        $page_data['latest_blogs'] = $this->crud_model->get_latest_blogs(6,$current_language);
    ...
    function blogs($param1 = ''){
        ...
        if(isset($_GET['search']) && !empty($_GET['search'])){
            ...
            $this->db->where('language', $current_language);
